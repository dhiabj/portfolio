export const SITE_URL = 'https://dhiabejaoui.com';
export const SITE_NAME = 'Dhia Bejaoui';
...
export const SOCIAL_LINKS = {
  github: 'https://github.com/dhiabj',
  linkedin: 'https://www.linkedin.com/in/dhia-bejaoui-147b98200/',
};
